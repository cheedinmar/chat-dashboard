export default{
    template:`
    <div class="flex flex-col sent-by-me">       
    <div class=" flex justify-end items-center ">
                <svg class="flex-shrink-0 w-4 h-2 mr-3 " viewBox="0 0 18 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <figcaption class="text-sm text-brand-gray border bg-white rounded-b-lg rounded-tr-lg py-3 px-5">
                        Can I send you files?
                    </figcaption>
                </div>
            <svg class="flex-shrink-0 w-4 h-2 ml-3 " viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.07749 0.141911C8.78816 -0.0860893 8.36949 -0.0340894 8.14216 0.255911L3.43883 6.26124L1.18616 3.46324C0.954159 3.17724 0.535492 3.13058 0.248826 3.36191C-0.0385075 3.59324 -0.0831742 4.01324 0.146826 4.29924L2.92616 7.75124C3.05349 7.90858 3.24416 7.99991 3.44616 7.99991H3.45083C3.65349 7.99858 3.84549 7.90458 3.97083 7.74391L9.19149 1.07724C9.41883 0.78791 9.36816 0.368577 9.07749 0.141911ZM12.4108 0.141911C12.1208 -0.0860893 11.7028 -0.0340894 11.4755 0.255911L6.77216 6.26124L6.36949 5.76191L5.52616 6.83991L6.25949 7.75124C6.38682 7.90858 6.57749 7.99991 6.77949 7.99991H6.78416C6.98682 7.99858 7.17882 7.90458 7.30416 7.74391L12.5248 1.07724C12.7522 0.78791 12.7015 0.368577 12.4108 0.141911ZM4.6533 3.62964L3.80863 4.70697L3.48063 4.29964C3.24996 4.01297 3.29463 3.59297 3.58196 3.36164C3.8693 3.13097 4.28863 3.17697 4.5193 3.46364L4.6533 3.62964Z" fill="#B7BDCB"/>
                </svg>
                    
    </div>
    <div class="flex justify-end mr-16 mt-2 ">
